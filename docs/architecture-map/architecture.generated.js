...
window.__OPENCOLORFUL_ARCHITECTURE__ = {
  ...
  "status": {
    "label": "P1 audit remediation in progress",
    "tone": "active",
    "summary": "Immediate fixes (5/5), Wave A/B fixture token adaptation, B4/B5 Electron true-chain, and the session SSE replay fix are merged; the follow-up remediation queue and manual acceptance cards remain open.",
  ...
  "knownGaps": [
    {
      "severity": "high",
      "title": "Audit remediation queue still has open items",
      "detail": "Immediate fixes (5/5), B4/B5 Electron true-chain, and the session SSE first-subscription replay fix are merged; usage durable spool, fork reconciliation, Desktop settings rollback, branch request generation/token, SSE notify dedupe, and Mock entry cleanup remain tracked on the project board.",
      "path": "docs/project-status.md"
    },
    {
      "severity": "medium",
      "title": "Web event allowlist follow-up",
      "detail": "The Web protocol client still lacks todo.updated, Wave B branch events, and turn terminal events that the server already emits; tracked in the audit remediation queue.",
      "path": "docs/project-status.md"
    },
    {
      "severity": "high",
      "title": "Release verification remains pending",
      "detail": "v0.1.1 assets are still Draft releases; out-of-repo install, update, restart, and data-recovery verification (G2) must pass before a public release decision.",
      "path": "plans/g2-desktop-release.md"
    }
  ],
  "rules": [
    {
  ...
  "locale": {
    "meta": {
      ...
      "statusLabel": "P1 审计修复进行中",
      "statusSummary": "立即修复 5/5、a4 令牌适配、B4/B5 Electron 真链与会话 SSE 首订重放修复已合并；审计修复队列剩余项与人工验收卡仍待收口。",
      "heroTitle": "先看懂它怎么运转，\n再走进每一层实现。",
      ...
      "projectBoard": {
        ...
        "devTodo": {
          "title": "开发者待办",
          "intro": "聚合所有需要开发者本人完成的验收与跟进事项：人工验收卡、审计修复队列与发布实测。自动化证据不能替代这里的任何一项。",
          "openCard": "打开卡片",
          "assignee": "需要：开发者本人",
          "empty": "没有待办——确认看板数据是否同步。"
        }
      },
      "modules": {
        "eyebrow": "单模块视图",
    ...
    "knownGaps": [
      {
        "severity": "高风险",
        "title": "审计后续修复队列仍有未闭环项",
        "detail": "立即修复 5/5、B4/B5 Electron 真链与会话 SSE 首订重放修复已合并；用量 spool、Fork 对账、设置回滚、分支 generation/token、SSE 合批去重与 Mock 入口收口仍在项目看板跟踪。"
      },
      {
        "severity": "中风险",
        "title": "Web 事件白名单还需要补齐",
        "detail": "Web 协议客户端还没有声明服务端已发送的 todo.updated、波次 B 分支事件与 turn 终态事件，已进入审计后续修复队列。"
      },
      {
        "severity": "高风险",
        "title": "发布验证仍未完成",
        "detail": "v0.1.1 发布资产仍是 Draft；仓库外安装、更新、重启与数据恢复实测（G2）通过前不能做正式发布判断。"
      }
    ]
  },
  "projectBoard": {
    ...
    "signals": [
      ...
      },
      {
        "label": "当前门槛",
        "value": "人工验收与发布验证未完成",
        "detail": "自动化与真链证据已闭环到 29/29，但不能替代审计 §8 人工验收卡和 G2 发布实测。",
        "source": "docs/audits/2026-09-06-wave-a-b-delivery-quality.zh.md"
      },
      {
        "label": "下一次真实反馈",
        "value": "5 天日用",
        "detail": "在修复队列、人工验收和发布链路完成后，再用连续日用观察产品质量。",
        "source": "docs/project-status.md"
      }
    ],
    "focus": [
      ...
      },
      {
        "number": "02",
        "title": "开发者亲测人工验收",
        "detail": "审计 §8 的 A1-A6 / B1-B7 必须开发者本人在真实桌面环境逐卡亲测，真链证据不能替代。",
        "cardId": "manual-acceptance-wave-a"
      },
      {
        "number": "03",
        "title": "最后做发布判断",
        ...
        "cards": [
          {
            ...
            "checklist": [
              {
                "label": "Runtime single-flight（#73）",
                "done": true
              },
              {
              ...
              {
                "label": "Fork JSONL/SQLite 对账与孤儿清理（#76）",
                "done": true
              },
              {
              ...
              {
                "label": "分支请求 generation/token（#78）",
                "done": true
              },
              {
                "label": "SSE 合批通知去重（#74）",
          ...
          },
          {
            ...
            "checklist": [
              {
                "label": "compact live / replay identity（#72 lane-b45）",
                "done": true
              },
              {
                "label": "durable todo true-chain（#72 lane-b45）",
                "done": true
              },
              {
                "label": "BRANCH-03/04 重复运行通过（#70，29/29 稳定）",
                "done": true
              },
              {
                "label": "A/B 人工验收卡完成",
          ...
          {
            "id": "manual-acceptance-wave-a",
            "type": "人工验收",
            "priority": "P1",
            "state": "待开发者亲测",
            "title": "人工验收卡 A1-A6（波次 A）",
            "summary": "开发者本人在真实桌面环境逐卡亲测：首次使用、Provider 失败、错误后继续、重启恢复、用量帮助决策、记忆长期使用。",
            "detail": "自动化与 Electron 真链不能替代人工验收。每卡记录 PASS / FAIL / BLOCKED-ENV / SKIP 与截图证据；失败恢复列必须真实操作，不能只看主路径。",
            "tags": [
              "人工验收",
              "Wave A",
              "开发者必做"
            ...
            "checklist": [
              {
                "label": "A-1 首次使用：引导 + 首条消息",
                "done": false
              },
              {
                "label": "A-2 Provider 失败：错误可理解可修复",
                "done": false
              },
              {
                "label": "A-3 错误后继续：一次失败不破坏会话",
                "done": false
              },
              {
                "label": "A-4 重启恢复：历史与模型可信恢复",
                "done": false
              },
              {
                "label": "A-5 用量帮助决策：区分来源/角色/模型",
                "done": false
              },
              {
                "label": "A-6 记忆长期使用：有帮助且不制造噪音",
                "done": false
              }
            ],
            "source": "docs/audits/2026-09-06-wave-a-b-delivery-quality.zh.md",
          ...
          {
            "id": "manual-acceptance-wave-b",
            "type": "人工验收",
            "priority": "P1",
            "state": "待开发者亲测",
            "title": "人工验收卡 B1-B7（波次 B）",
            "summary": "开发者本人在真实桌面环境逐卡亲测：编辑重生成、重试、切换分支、Fork、压缩摘要、Todo、长时间混用。",
            "detail": "B4/B5 真链自动化证据（#72 lane-b45）可作参考，但每卡仍需真人操作并记录状态与证据。B-7 长时间混用是唯一能暴露复杂度反噬的场景。",
            "tags": [
              "人工验收",
              "Wave B",
              "开发者必做"
            ...
            "checklist": [
              {
                "label": "B-1 编辑并重生成：新分支成当前，旧分支可找回",
                "done": false
              },
              {
                "label": "B-2 重试：兄弟分支，原文与旧结果保留",
                "done": false
              },
              {
                "label": "B-3 切换分支：来回切换后时间线一致",
                "done": false
              },
              {
                "label": "B-4 Fork：新会话独立，失败不留孤儿",
                "done": false
              },
              {
                "label": "B-5 压缩摘要：/compact 可读、重启可续",
                "done": false
              },
              {
                "label": "B-6 Todo：与实际进展一致、重启可信",
                "done": false
              },
              {
                "label": "B-7 长时间混用：数小时仍可理解",
                "done": false
              }
            ],
            "source": "docs/audits/2026-09-06-wave-a-b-delivery-quality.zh.md",
            "references": [
              ...
              {
                "label": "B4/B5 真链实施记录",
                "path": "plans/p1-audit-remediation-b45-electron-truechain.en.md"
              }
            ]
          },
          {
