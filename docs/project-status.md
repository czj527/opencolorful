...
1. **P1 波次八验收（待作者执行）**：切片 1.5 已于 2026-08-28 全部合并（PR #26-#29）。作者按 `plans/desktop-e2e-test-plan.md` 执行 I 组回归（I7 按会话中心 IA 改写）+ 切片 1.5 验证项（流畅度/零死控件/IA 自洽/环境坑消除），通过后继续 5 天真实日用。
