...
import { subagentActivityEntries, subagentAuditEntries } from "./catalog/subagent-events.js";
...
export const ObservabilityEventCatalog: ReadonlyMap<string, EventCatalogEntry> = new Map(
  (
    [
      ...
      entry({ eventName: "memory.review.started", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "info", lifecycleRole: "started", terminalStatuses: ["completed", "degraded", "failed", "interrupted"], ...routine }),
      entry({ eventName: "memory.review.completed", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "info", lifecycleRole: "terminal", terminalStatuses: ["completed"], ...routine }),
      entry({ eventName: "memory.review.degraded", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "warn", lifecycleRole: "terminal", terminalStatuses: ["degraded"], ...routine }),
      entry({ eventName: "memory.review.failed", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "error", lifecycleRole: "terminal", terminalStatuses: ["failed"], ...routine }),
      ...
      entry({ eventName: "memory.proposal.reverted", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "info", lifecycleRole: "point", ...notable, auditMirror: "audit.memory.proposal_reverted" }),
      ...
      entry({ eventName: "memory.event.forgotten", eventVersion: 1, channel: "activity", category: "memory", defaultLevel: "info", lifecycleRole: "point", ...notable, auditMirror: "audit.memory.event_forgotten" }),
      ...
      // Phase 14（T1 冻结）：Subagent 事件见 catalog/subagent-events.ts
      ...pluginActivityEntries,
      ...skillActivityEntries,
      ...subagentActivityEntries,
      ...
      entry({ eventName: "audit.agent.workspace_change.started", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "started", significance: "notable" }),
      entry({ eventName: "audit.agent.workspace_change.failed", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "warn", lifecycleRole: "terminal", significance: "notable" }),
      entry({ eventName: "audit.agent.workspace_changed", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "warn", lifecycleRole: "terminal", significance: "notable" }),
      entry({ eventName: "audit.session.workspace_bind.started", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "started", significance: "notable" }),
      entry({ eventName: "audit.session.workspace_bind.failed", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "warn", lifecycleRole: "terminal", significance: "notable" }),
      entry({ eventName: "audit.session.workspace_bound", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "terminal", significance: "notable" }),
      ...
      entry({ eventName: "audit.sandbox.policy_change.started", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "started", significance: "notable" }),
      entry({ eventName: "audit.sandbox.policy_change.failed", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "warn", lifecycleRole: "terminal", significance: "notable" }),
      entry({ eventName: "audit.sandbox.policy_changed", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "warn", lifecycleRole: "terminal", significance: "notable" }),
      ...
      entry({ eventName: "audit.memory.proposal_reverted", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "point", significance: "notable" }),
      ...
      entry({ eventName: "audit.memory.event_forgotten", eventVersion: 1, channel: "audit", category: "audit", defaultLevel: "info", lifecycleRole: "point", significance: "notable" }),
